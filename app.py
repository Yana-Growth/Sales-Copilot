        ...
        if not api_key:
            ...
            with st.spinner("Анализирую логи GetSales и пишу ответ..."):
                try:
                    ...
                    - Если клиент использует конкурента (указанного в таблице конкурентов) или B2C сервис, деликатно сравни B2B платформу Tumodo с их решением, опираясь на сильные стороны Tumodo из Базы Знаний.
                    ...
                    БАЗА ЗНАНИЙ (учитывай эти тезисы и таблицы конкурентов):
                    {kb_context}
